...
**[← 返回首页](../../README.md)** · **[📦 未实现能力设计归档](../agent-unimplemented-design.md)** · **[🚢 部署指南](../deployment/DEPLOYMENT.md)** · **[📐 项目架构](./PROJECT_OVERVIEW.md)**
...
**文件位置**：
- 增强索引器：[apps/api/src/indexing/enhanced-indexer.ts](../../apps/api/src/indexing/enhanced-indexer.ts)
- 语言适配层：[apps/api/src/indexing/languages/types.ts](../../apps/api/src/indexing/languages/types.ts)（契约）+ [registry.ts](../../apps/api/src/indexing/languages/registry.ts)（分发）
- TS/JS 解析：[chunker.ts](../../apps/api/src/indexing/languages/typescript/chunker.ts)（Babel 代码块）/ [entities.ts](../../apps/api/src/indexing/languages/typescript/entities.ts)（ts-morph 结构化实体）
- 跨文件符号表：[url-resolver.ts](../../apps/api/src/indexing/languages/typescript/url-resolver.ts)
- Vue SFC 解包：[sfc-host.ts](../../apps/api/src/indexing/languages/typescript/sfc-host.ts)
- 关系构建器：[apps/api/src/indexing/relationship-builder.ts](../../apps/api/src/indexing/relationship-builder.ts)
- 依赖追踪器：[apps/api/src/indexing/dependency-tracker.ts](../../apps/api/src/indexing/dependency-tracker.ts)
...
3. AST 分析（提取函数、类、常量、URL）
   ↓
4. 生成向量（qwen3.7-text-embedding, 1536维）
   ↓
5. 构建关系（导入、引用、调用）
   ↓
6. 存储到数据库
...
**文件位置**：
- 多策略搜索：[apps/api/src/retrieval/multi-strategy-search.ts](../../apps/api/src/retrieval/multi-strategy-search.ts)
- URL 搜索：[apps/api/src/retrieval/url-search.ts](../../apps/api/src/retrieval/url-search.ts)
- URL 推导：[apps/api/src/retrieval/url-derivation.ts](../../apps/api/src/retrieval/url-derivation.ts)
...
**文件位置**：
- 多语言分词器：[apps/api/src/retrieval/multilingual-tokenizer.ts](../../apps/api/src/retrieval/multilingual-tokenizer.ts)
...
**文件位置**：
- 缓存工具：[apps/api/src/cache/lru-cache.ts](../../apps/api/src/cache/lru-cache.ts)
...
**文件位置**：
- 搜索建议：[apps/api/src/retrieval/search-suggestions.ts](../../apps/api/src/retrieval/search-suggestions.ts)
...
**文件位置**：
- 去重工具：[apps/api/src/retrieval/deduplication.ts](../../apps/api/src/retrieval/deduplication.ts)
...
[apps/api/src/retrieval/multi-strategy-search.ts](../../apps/api/src/retrieval/multi-strategy-search.ts)
...
[apps/api/src/retrieval/url-derivation.ts](../../apps/api/src/retrieval/url-derivation.ts)
...
[apps/api/src/cache/lru-cache.ts](../../apps/api/src/cache/lru-cache.ts)
...
[apps/api/src/retrieval/multilingual-tokenizer.ts](../../apps/api/src/retrieval/multilingual-tokenizer.ts)
